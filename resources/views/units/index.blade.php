...
@section('header', '📏 จัดการหน่วยนับ')
@section('subtitle', 'เพิ่ม/ลบ/แก้ไข หน่วยนับสำหรับอุปกรณ์')

@section('content')
    <div id="units-page" class="page animate-slide-up-soft">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {{-- ซ้าย: ฟอร์มเพิ่มหน่วยนับแบบคงที่ --}}
            <div class="lg:col-span-1">
                <div class="soft-card rounded-2xl p-6 gentle-shadow sticky top-24">
                    <h3 class="text-xl font-bold gradient-text-soft mb-4">📏 เพิ่มหน่วยนับใหม่</h3>
                    ...
                    {{-- Create form (RESTful: POST -> units.store) --}}
                    <form method="POST" action="{{ route('units.store') }}">
                        @csrf
                        <div class="space-y-4">
                            <div>
                                <label for="name" class="block text-sm font-medium text-gray-700">ชื่อหน่วยนับ *</label>
                                <input
                                    type="text"
                                    name="name"
                                    id="name"
            ...
            <div class="lg:col-span-2">
                <div class="soft-card rounded-2xl p-6 gentle-shadow">
                    <h3 class="text-xl font-bold text-gray-800 mb-4">รายการหน่วยนับทั้งหมด</h3>

                    <div class="overflow-x-auto scrollbar-soft">
                        <table class="w-full">
                            <thead class="bg-gradient-to-r from-blue-50 to-purple-50">
                                <tr>
                                    <th class="px-4 py-3 text-left font-medium text-gray-700 text-sm">ชื่อหน่วยนับ</th>
